...
type LaunchVehicleEntity struct {
	name    string
...
func NewLaunchVehicleEntity(client *core.LaunchLibrary2SDK, entopts map[string]any) *LaunchVehicleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LaunchVehicleEntity) GetName() string { return e.name }
...
func (e *LaunchVehicleEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LaunchVehicleEntity) Deleted() bool {
	return e.deleted
}


func (e *LaunchVehicleEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLaunchVehicleEntity(e.client, opts)
}

func (e *LaunchVehicleEntity) Data(args ...any) any {
...
func (e *LaunchVehicleEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an LaunchVehicle; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LaunchVehicleEntity) DataTyped(data ...LaunchVehicle) LaunchVehicle {
	if len(data) > 0 {
		return typedFrom[LaunchVehicle](e.Data(asMap(data[0])))
	}
	return typedFrom[LaunchVehicle](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through LaunchVehicle (all fields
// optional at the wire level).
func (e *LaunchVehicleEntity) MatchTyped(match ...LaunchVehicle) LaunchVehicle {
	if len(match) > 0 {
		return typedFrom[LaunchVehicle](e.Match(asMap(match[0])))
	}
	return typedFrom[LaunchVehicle](e.Match())
}
...
func (e *LaunchVehicleEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LaunchVehicleEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *LaunchVehicleEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LaunchVehicleListMatch and returns []LaunchVehicle. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *LaunchVehicleEntity) ListTyped(reqmatch LaunchVehicleListMatch, ctrl map[string]any) ([]LaunchVehicle, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[LaunchVehicle](res), nil
}



func (e *LaunchVehicleEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LaunchVehicleEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LaunchVehicleEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LaunchVehicleEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
