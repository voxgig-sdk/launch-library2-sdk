...
func NewAstronautEntity(client *core.LaunchLibrary2SDK, entopts map[string]any) *AstronautEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AstronautEntity) GetName() string { return e.name }
...
func (e *AstronautEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AstronautEntity) Deleted() bool {
	return e.deleted
}


func (e *AstronautEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAstronautEntity(e.client, opts)
}

func (e *AstronautEntity) Data(args ...any) any {
...
func (e *AstronautEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Astronaut; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AstronautEntity) DataTyped(data ...Astronaut) Astronaut {
	if len(data) > 0 {
		return typedFrom[Astronaut](e.Data(asMap(data[0])))
	}
	return typedFrom[Astronaut](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Astronaut (all fields
// optional at the wire level).
func (e *AstronautEntity) MatchTyped(match ...Astronaut) Astronaut {
	if len(match) > 0 {
		return typedFrom[Astronaut](e.Match(asMap(match[0])))
	}
	return typedFrom[Astronaut](e.Match())
}
...
func (e *AstronautEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AstronautEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AstronautLoadMatch and returns an Astronaut. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AstronautEntity) LoadTyped(reqmatch AstronautLoadMatch, ctrl map[string]any) (Astronaut, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Astronaut{}, err
	}
	return typedFrom[Astronaut](res), nil
}




func (e *AstronautEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// AstronautListMatch and returns []Astronaut. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AstronautEntity) ListTyped(reqmatch AstronautListMatch, ctrl map[string]any) ([]Astronaut, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Astronaut](res), nil
}



func (e *AstronautEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AstronautEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AstronautEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AstronautEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
