...
func NewPadEntity(client *core.LaunchLibrary2SDK, entopts map[string]any) *PadEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PadEntity) GetName() string { return e.name }
...
func (e *PadEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PadEntity) Deleted() bool {
	return e.deleted
}


func (e *PadEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPadEntity(e.client, opts)
}

func (e *PadEntity) Data(args ...any) any {
...
func (e *PadEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Pad; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PadEntity) DataTyped(data ...Pad) Pad {
	if len(data) > 0 {
		return typedFrom[Pad](e.Data(asMap(data[0])))
	}
	return typedFrom[Pad](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Pad (all fields
// optional at the wire level).
func (e *PadEntity) MatchTyped(match ...Pad) Pad {
	if len(match) > 0 {
		return typedFrom[Pad](e.Match(asMap(match[0])))
	}
	return typedFrom[Pad](e.Match())
}
...
func (e *PadEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PadEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PadLoadMatch and returns an Pad. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *PadEntity) LoadTyped(reqmatch PadLoadMatch, ctrl map[string]any) (Pad, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Pad{}, err
	}
	return typedFrom[Pad](res), nil
}




func (e *PadEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// PadListMatch and returns []Pad. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PadEntity) ListTyped(reqmatch PadListMatch, ctrl map[string]any) ([]Pad, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Pad](res), nil
}



func (e *PadEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PadEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PadEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PadEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
