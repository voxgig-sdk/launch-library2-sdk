...
func NewSpacecraftEntity(client *core.LaunchLibrary2SDK, entopts map[string]any) *SpacecraftEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *SpacecraftEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// SpacecraftLoadMatch and returns an Spacecraft. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *SpacecraftEntity) LoadTyped(reqmatch SpacecraftLoadMatch, ctrl map[string]any) (Spacecraft, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Spacecraft{}, err
	}
	return typedFrom[Spacecraft](res), nil
}
