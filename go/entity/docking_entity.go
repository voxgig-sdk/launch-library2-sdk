...
func NewDockingEntity(client *core.LaunchLibrary2SDK, entopts map[string]any) *DockingEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *DockingEntity) GetName() string { return e.name }
...
func (e *DockingEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *DockingEntity) Deleted() bool {
	return e.deleted
}


func (e *DockingEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewDockingEntity(e.client, opts)
}

func (e *DockingEntity) Data(args ...any) any {
...
func (e *DockingEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *DockingEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *DockingEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *DockingEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *DockingEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *DockingEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *DockingEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
