...
func NewFirstStageEntity(client *core.LaunchLibrary2SDK, entopts map[string]any) *FirstStageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *FirstStageEntity) GetName() string { return e.name }
...
func (e *FirstStageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *FirstStageEntity) Deleted() bool {
	return e.deleted
}


func (e *FirstStageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewFirstStageEntity(e.client, opts)
}

func (e *FirstStageEntity) Data(args ...any) any {
...
func (e *FirstStageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an FirstStage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *FirstStageEntity) DataTyped(data ...FirstStage) FirstStage {
	if len(data) > 0 {
		return typedFrom[FirstStage](e.Data(asMap(data[0])))
	}
	return typedFrom[FirstStage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through FirstStage (all fields
// optional at the wire level).
func (e *FirstStageEntity) MatchTyped(match ...FirstStage) FirstStage {
	if len(match) > 0 {
		return typedFrom[FirstStage](e.Match(asMap(match[0])))
	}
	return typedFrom[FirstStage](e.Match())
}
...
func (e *FirstStageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *FirstStageEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// FirstStageLoadMatch and returns an FirstStage. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *FirstStageEntity) LoadTyped(reqmatch FirstStageLoadMatch, ctrl map[string]any) (FirstStage, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return FirstStage{}, err
	}
	return typedFrom[FirstStage](res), nil
}




func (e *FirstStageEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// FirstStageListMatch and returns []FirstStage. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *FirstStageEntity) ListTyped(reqmatch FirstStageListMatch, ctrl map[string]any) ([]FirstStage, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[FirstStage](res), nil
}



func (e *FirstStageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *FirstStageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *FirstStageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *FirstStageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
