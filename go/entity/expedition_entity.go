...
func NewExpeditionEntity(client *core.LaunchLibrary2SDK, entopts map[string]any) *ExpeditionEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ExpeditionEntity) GetName() string { return e.name }
...
func (e *ExpeditionEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ExpeditionEntity) Deleted() bool {
	return e.deleted
}


func (e *ExpeditionEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewExpeditionEntity(e.client, opts)
}

func (e *ExpeditionEntity) Data(args ...any) any {
...
func (e *ExpeditionEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *ExpeditionEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ExpeditionEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *ExpeditionEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ExpeditionEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ExpeditionEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ExpeditionEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
