...
func NewReusableFirstStageEntity(client *core.LaunchLibrary2SDK, entopts map[string]any) *ReusableFirstStageEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ReusableFirstStageEntity) GetName() string { return e.name }
...
func (e *ReusableFirstStageEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ReusableFirstStageEntity) Deleted() bool {
	return e.deleted
}


func (e *ReusableFirstStageEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewReusableFirstStageEntity(e.client, opts)
}

func (e *ReusableFirstStageEntity) Data(args ...any) any {
...
func (e *ReusableFirstStageEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an ReusableFirstStage; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ReusableFirstStageEntity) DataTyped(data ...ReusableFirstStage) ReusableFirstStage {
	if len(data) > 0 {
		return typedFrom[ReusableFirstStage](e.Data(asMap(data[0])))
	}
	return typedFrom[ReusableFirstStage](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through ReusableFirstStage (all fields
// optional at the wire level).
func (e *ReusableFirstStageEntity) MatchTyped(match ...ReusableFirstStage) ReusableFirstStage {
	if len(match) > 0 {
		return typedFrom[ReusableFirstStage](e.Match(asMap(match[0])))
	}
	return typedFrom[ReusableFirstStage](e.Match())
}
...
func (e *ReusableFirstStageEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ReusableFirstStageEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *ReusableFirstStageEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ReusableFirstStageEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ReusableFirstStageEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ReusableFirstStageEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ReusableFirstStageEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
