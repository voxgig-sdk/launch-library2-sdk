...
func NewAgencyEntity(client *core.LaunchLibrary2SDK, entopts map[string]any) *AgencyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *AgencyEntity) GetName() string { return e.name }
...
func (e *AgencyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *AgencyEntity) Deleted() bool {
	return e.deleted
}


func (e *AgencyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewAgencyEntity(e.client, opts)
}

func (e *AgencyEntity) Data(args ...any) any {
...
func (e *AgencyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Agency; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *AgencyEntity) DataTyped(data ...Agency) Agency {
	if len(data) > 0 {
		return typedFrom[Agency](e.Data(asMap(data[0])))
	}
	return typedFrom[Agency](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Agency (all fields
// optional at the wire level).
func (e *AgencyEntity) MatchTyped(match ...Agency) Agency {
	if len(match) > 0 {
		return typedFrom[Agency](e.Match(asMap(match[0])))
	}
	return typedFrom[Agency](e.Match())
}
...
func (e *AgencyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *AgencyEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// AgencyLoadMatch and returns an Agency. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *AgencyEntity) LoadTyped(reqmatch AgencyLoadMatch, ctrl map[string]any) (Agency, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Agency{}, err
	}
	return typedFrom[Agency](res), nil
}




func (e *AgencyEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
// AgencyListMatch and returns []Agency. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *AgencyEntity) ListTyped(reqmatch AgencyListMatch, ctrl map[string]any) ([]Agency, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Agency](res), nil
}



func (e *AgencyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *AgencyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *AgencyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *AgencyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
