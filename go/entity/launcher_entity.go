...
func NewLauncherEntity(client *core.LaunchLibrary2SDK, entopts map[string]any) *LauncherEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *LauncherEntity) GetName() string { return e.name }
...
func (e *LauncherEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *LauncherEntity) Deleted() bool {
	return e.deleted
}


func (e *LauncherEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewLauncherEntity(e.client, opts)
}

func (e *LauncherEntity) Data(args ...any) any {
...
func (e *LauncherEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Launcher; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *LauncherEntity) DataTyped(data ...Launcher) Launcher {
	if len(data) > 0 {
		return typedFrom[Launcher](e.Data(asMap(data[0])))
	}
	return typedFrom[Launcher](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Launcher (all fields
// optional at the wire level).
func (e *LauncherEntity) MatchTyped(match ...Launcher) Launcher {
	if len(match) > 0 {
		return typedFrom[Launcher](e.Match(asMap(match[0])))
	}
	return typedFrom[Launcher](e.Match())
}
...
func (e *LauncherEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *LauncherEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// LauncherLoadMatch and returns an Launcher. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *LauncherEntity) LoadTyped(reqmatch LauncherLoadMatch, ctrl map[string]any) (Launcher, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Launcher{}, err
	}
	return typedFrom[Launcher](res), nil
}



func (e *LauncherEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *LauncherEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *LauncherEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *LauncherEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *LauncherEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
