...
func TestExpeditionEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		expeditionRef01DataDt0LoadResult := core.ToMapAny(entityData(expeditionRef01DataDt0Loaded))
...
func expeditionBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("LAUNCH_LIBRARY2_TEST_EXPEDITION_ENTID")
	...
	idmapResolved := core.ToMapAny(env["LAUNCH_LIBRARY2_TEST_EXPEDITION_ENTID"])
