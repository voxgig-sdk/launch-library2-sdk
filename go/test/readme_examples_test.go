...
const testSeed = `map[string]any{"entity": map[string]any{"agency": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "astronaut": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "docking": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "docking_event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "event": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "expedition": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "first_stage": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "launch": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "launch_vehicle": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "launcher": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "location": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pad": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "reusable_first_stage": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "space_station": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "spacecraft": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
