...
func TestLaunchVehicleEntity(t *testing.T) {
	...
	t.Run("basic", func(t *testing.T) {
		...
		if setup.syntheticOnly {
			t.Skip("live entity test uses synthetic IDs from fixture — set LAUNCHLIBRARY__TEST_LAUNCH_VEHICLE_ENTID JSON to run live")
			return
		}
		client := setup.client
...
func launch_vehicleBasicSetup(extra map[string]any) *entityTestSetup {
	...
	entidEnvRaw := os.Getenv("LAUNCHLIBRARY__TEST_LAUNCH_VEHICLE_ENTID")
