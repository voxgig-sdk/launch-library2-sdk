...
The Golang SDK for the LaunchLibrary2 API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/launch-library2-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/launch-library2-sdk=../path/to/github.com/voxgig-sdk/launch-library2-sdk
```
...
```
github.com/voxgig-sdk/launch-library2-sdk/
...
The root package (`github.com/voxgig-sdk/launch-library2-sdk`) re-exports everything needed
