...
func registerSDKWords(r *eng.Registry, client *sdk.LaunchLibrary2SDK) {
...
func runOp(client *sdk.LaunchLibrary2SDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
