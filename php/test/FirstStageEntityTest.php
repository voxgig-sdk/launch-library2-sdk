...
class FirstStageEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LAUNCHLIBRARY__TEST_FIRST_STAGE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function first_stage_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LAUNCHLIBRARY__TEST_FIRST_STAGE_ENTID");
