...
class LaunchLibrary2TestRunner
{
    ...
    {
        $live = self::getenv('LAUNCH_LIBRARY2_TEST_LIVE');
        $override = self::getenv('LAUNCH_LIBRARY2_TEST_OVERRIDE');
        ...
        $explain = self::getenv('LAUNCH_LIBRARY2_TEST_EXPLAIN');
...
class_alias('LaunchLibrary2TestRunner', 'Runner');
class_alias('LaunchLibrary2Helpers', 'Helpers');
