...
class LaunchEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set LAUNCH_LIBRARY2_TEST_LAUNCH_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function launch_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("LAUNCH_LIBRARY2_TEST_LAUNCH_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["LAUNCH_LIBRARY2_TEST_LAUNCH_ENTID"]);
