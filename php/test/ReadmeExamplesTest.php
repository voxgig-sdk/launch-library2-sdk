...
// LaunchLibrary2 SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (LaunchLibrary2SDK::test)
...
{
    private const SDK_CLASS = 'LaunchLibrary2SDK';
    ...
    private const SDK_BASE = 'launchlibrary2_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../launchlibrary2_sdk.php';
