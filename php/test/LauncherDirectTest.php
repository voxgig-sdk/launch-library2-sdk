...
class LauncherDirectTest extends TestCase
{
    public function test_direct_load_launcher(): void
    {
        $setup = launcher_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-launcher", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
...
function launcher_direct_setup($mockres)
{
