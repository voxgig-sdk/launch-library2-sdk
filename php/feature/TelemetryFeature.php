...
// LaunchLibrary2 SDK telemetry feature
...
class LaunchLibrary2TelemetryFeature extends LaunchLibrary2BaseFeature
{
    ...
    private function _close(LaunchLibrary2Context $ctx, bool $ok): void
    {
