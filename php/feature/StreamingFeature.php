...
// LaunchLibrary2 SDK streaming feature
...
class LaunchLibrary2StreamingFeature extends LaunchLibrary2BaseFeature
{
    ...
    private function _iterate(LaunchLibrary2Result $result): \Generator
    {
    ...
    private function _streamable(LaunchLibrary2Context $ctx): bool
    {
