...
// LaunchLibrary2 SDK netsim feature
...
class LaunchLibrary2NetsimFeature extends LaunchLibrary2BaseFeature
{
    ...
    private function _simulate(LaunchLibrary2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(LaunchLibrary2Context $ctx, array $applied): void
    {
        $client = $this->client;
