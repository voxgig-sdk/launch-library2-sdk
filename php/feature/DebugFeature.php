...
// LaunchLibrary2 SDK debug feature
...
class LaunchLibrary2DebugFeature extends LaunchLibrary2BaseFeature
{
    ...
    private function _finish(LaunchLibrary2Context $ctx, bool $ok): void
    {
