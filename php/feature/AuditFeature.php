...
// LaunchLibrary2 SDK audit feature
...
class LaunchLibrary2AuditFeature extends LaunchLibrary2BaseFeature
{
    ...
    private function _emit(LaunchLibrary2Context $ctx, string $outcome): void
    {
