...
// LaunchLibrary2 SDK timeout feature
...
class LaunchLibrary2TimeoutFeature extends LaunchLibrary2BaseFeature
{
    ...
    private function _with_timeout(LaunchLibrary2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(LaunchLibrary2Context $_ctx, float $ms): void
    {
        $client = $this->client;
