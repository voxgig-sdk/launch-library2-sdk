...
// LaunchLibrary2 SDK utility type

class LaunchLibrary2Utility
{
    ...
    public static function copy(LaunchLibrary2Utility $src): LaunchLibrary2Utility
    {
        $u = new LaunchLibrary2Utility();
        $u->clean = $src->clean;
        $u->done = $src->done;
