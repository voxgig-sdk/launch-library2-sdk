...
class AgencyEntity
{
     ...
     *
     * @param AgencyLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AgencyLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Agency|array The loaded Agency as an assoc-array at the
