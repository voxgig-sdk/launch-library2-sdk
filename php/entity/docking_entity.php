...
class DockingEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DockingEntity($this->_client, $opts);
    }

    /**
     * @param Docking|array $args Docking data (assoc-array) to store.
     */
    ...
    /**
     * @return Docking|array The current Docking data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Docking fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Docking fields).
     */
