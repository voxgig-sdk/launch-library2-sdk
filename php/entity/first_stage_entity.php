...
// LaunchLibrary2 SDK FirstStage entity
...
class FirstStageEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new FirstStageEntity($this->_client, $opts);
    }

    /**
     * @param FirstStage|array $args FirstStage data (assoc-array) to store.
     */
    ...
    /**
     * @return FirstStage|array The current FirstStage data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of FirstStage fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of FirstStage fields).
     */
     ...
     *
     * @param FirstStageLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed FirstStageLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FirstStage|array The loaded FirstStage as an assoc-array at the
     ...
     *
     * @param FirstStageListMatch|array|null $reqmatch Match filter (any subset
     *   of FirstStage fields) as an assoc-array; FirstStageListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return FirstStage[]|array A list of FirstStage items as assoc-arrays at
