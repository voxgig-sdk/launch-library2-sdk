...
// LaunchLibrary2 SDK Astronaut entity
...
class AstronautEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new AstronautEntity($this->_client, $opts);
    }

    /**
     * @param Astronaut|array $args Astronaut data (assoc-array) to store.
     */
    ...
    /**
     * @return Astronaut|array The current Astronaut data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Astronaut fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Astronaut fields).
     */
     ...
     *
     * @param AstronautLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed AstronautLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Astronaut|array The loaded Astronaut as an assoc-array at the
     ...
     *
     * @param AstronautListMatch|array|null $reqmatch Match filter (any subset
     *   of Astronaut fields) as an assoc-array; AstronautListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Astronaut[]|array A list of Astronaut items as assoc-arrays at
