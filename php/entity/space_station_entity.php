...
// LaunchLibrary2 SDK SpaceStation entity
...
class SpaceStationEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new SpaceStationEntity($this->_client, $opts);
    }

    /**
     * @param SpaceStation|array $args SpaceStation data (assoc-array) to store.
     */
    ...
    /**
     * @return SpaceStation|array The current SpaceStation data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of SpaceStation fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of SpaceStation fields).
     */
    ...
    /**
     * Load a single SpaceStation.
     *
     * @param SpaceStationLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed SpaceStationLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SpaceStation|array The loaded SpaceStation as an assoc-array at the
    ...
    /**
     * List SpaceStation items matching the given filter.
     *
     * @param SpaceStationListMatch|array|null $reqmatch Match filter (any subset
     *   of SpaceStation fields) as an assoc-array; SpaceStationListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return SpaceStation[]|array A list of SpaceStation items as assoc-arrays at
