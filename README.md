...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/launch-library2` | `npm install @voxgig-sdk/launch-library2` |
| Python | `voxgig-sdk-launch-library2` | `pip install voxgig-sdk-launch-library2` |
| PHP | `voxgig-sdk/launch-library2` | `composer require voxgig-sdk/launch-library2` |
| Golang | `github.com/voxgig-sdk/launch-library2-sdk/go` | `go get github.com/voxgig-sdk/launch-library2-sdk/go` |
| Ruby | `voxgig-sdk-launch-library2` | `gem install voxgig-sdk-launch-library2` |
| Lua | `voxgig-sdk-launch-library2` | `luarocks install voxgig-sdk-launch-library2` |
