...
local LaunchVehicleEntity = {}
LaunchVehicleEntity.__index = LaunchVehicleEntity


function LaunchVehicleEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, LaunchVehicleEntity)
  self._name = "launch_vehicle"
  self._client = client
...
function LaunchVehicleEntity:get_name()
  return self._name
end


function LaunchVehicleEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return LaunchVehicleEntity.new(self._client, opts)
end
...
function LaunchVehicleEntity:mark_deleted()
  self._deleted = true
end


function LaunchVehicleEntity:deleted()
  return true == self._deleted
end


function LaunchVehicleEntity:data_set(args)
  if args ~= nil then
...
function LaunchVehicleEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function LaunchVehicleEntity:match_set(args)
  if args ~= nil then
...
function LaunchVehicleEntity:match_get()
...
function LaunchVehicleEntity:stream(action, args, callopts)
...
function LaunchVehicleEntity:_run_op(ctx, post_done)
  local utility = self._utility
