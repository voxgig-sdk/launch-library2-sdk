...
local ExpeditionEntity = {}
ExpeditionEntity.__index = ExpeditionEntity


function ExpeditionEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ExpeditionEntity)
  self._name = "expedition"
  self._client = client
...
function ExpeditionEntity:get_name()
  return self._name
end


function ExpeditionEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ExpeditionEntity.new(self._client, opts)
end
...
function ExpeditionEntity:mark_deleted()
  self._deleted = true
end


function ExpeditionEntity:deleted()
  return true == self._deleted
end


function ExpeditionEntity:data_set(args)
  if args ~= nil then
...
function ExpeditionEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ExpeditionEntity:match_set(args)
  if args ~= nil then
...
function ExpeditionEntity:match_get()
...
function ExpeditionEntity:stream(action, args, callopts)
...
function ExpeditionEntity:_run_op(ctx, post_done)
  local utility = self._utility
