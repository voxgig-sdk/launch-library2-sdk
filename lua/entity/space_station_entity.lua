...
local SpaceStationEntity = {}
SpaceStationEntity.__index = SpaceStationEntity


function SpaceStationEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, SpaceStationEntity)
  self._name = "space_station"
  self._client = client
...
function SpaceStationEntity:get_name()
  return self._name
end


function SpaceStationEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return SpaceStationEntity.new(self._client, opts)
end
...
function SpaceStationEntity:mark_deleted()
  self._deleted = true
end


function SpaceStationEntity:deleted()
  return true == self._deleted
end


function SpaceStationEntity:data_set(args)
  if args ~= nil then
...
function SpaceStationEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function SpaceStationEntity:match_set(args)
  if args ~= nil then
...
function SpaceStationEntity:match_get()
...
function SpaceStationEntity:stream(action, args, callopts)
...
function SpaceStationEntity:_run_op(ctx, post_done)
  local utility = self._utility
