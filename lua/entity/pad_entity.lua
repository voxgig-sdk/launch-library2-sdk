...
local PadEntity = {}
PadEntity.__index = PadEntity


function PadEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, PadEntity)
  self._name = "pad"
  self._client = client
...
function PadEntity:get_name()
  return self._name
end


function PadEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return PadEntity.new(self._client, opts)
end
...
function PadEntity:mark_deleted()
  self._deleted = true
end


function PadEntity:deleted()
  return true == self._deleted
end


function PadEntity:data_set(args)
  if args ~= nil then
...
function PadEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function PadEntity:match_set(args)
  if args ~= nil then
...
function PadEntity:stream(action, args, callopts)
...
function PadEntity:_run_op(ctx, post_done)
  local utility = self._utility
