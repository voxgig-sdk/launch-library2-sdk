...
-- by passing it.
function LaunchLibrary2SDK:_raw_request(fetchargs)
  local utility = self._utility
...
function LaunchLibrary2SDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "LaunchLibrary2SDK: graphql: " .. msg
    res.graphql = errors
  end
