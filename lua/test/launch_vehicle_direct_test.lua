...
describe("LaunchVehicleDirect", function()
  it("should direct-list-launch_vehicle", function()
    local setup = launch_vehicle_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-launch_vehicle", setup.live and "live" or "unit")
