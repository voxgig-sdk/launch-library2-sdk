...
describe("LauncherDirect", function()
  it("should direct-load-launcher", function()
    local setup = launcher_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-launcher", setup.live and "live" or "unit")
