# LaunchLibrary2 SDK — Agent Guide
...
**Entities** (15): `Agency`, `Astronaut`, `Docking`, `DockingEvent`, `Event`, `Expedition`, `FirstStage`, `Launch`, `LaunchVehicle`, `Launcher`, `Location`, `Pad`, `ReusableFirstStage`, `SpaceStation`, `Spacecraft`.
