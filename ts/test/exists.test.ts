...
describe('exists', async () => {
  ...
  //
  // LaunchLibrary2SDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof LaunchLibrary2SDK, true,
      'LaunchLibrary2SDK.test() must return a client synchronously')
  })
