...
describe('SpacecraftDirect', async () => {
  ...
  test('direct-load-spacecraft', async (t: any) => {
    const setup = directSetup({ id: 'direct01' })
    if (maybeSkipControl(t, 'direct', 'direct-load-spacecraft', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['LAUNCH_LIBRARY2_TEST_SPACECRAFT_ENTID']
