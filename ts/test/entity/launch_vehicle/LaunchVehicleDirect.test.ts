...
describe('LaunchVehicleDirect', async () => {
  ...
  test('direct-list-launch_vehicle', async (t: any) => {
    const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }])
    if (maybeSkipControl(t, 'direct', 'direct-list-launch_vehicle', setup.live)) return
...
function directSetup(mockres?: any) {
  ...
  if (live) {
    ...
    let idmap: any = env['LAUNCH_LIBRARY2_TEST_LAUNCH_VEHICLE_ENTID']
