...
//     (\`new LaunchLibrary2SDK(...)\` / \`LaunchLibrary2SDK.test(...)\` become
//     \`LaunchLibrary2SDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'LaunchLibrary2SDK'
...
const TEST_SEED = {"entity":{"agency":{"test01":{"id":"test01"}},"astronaut":{"test01":{"id":"test01"}},"docking":{"test01":{"id":"test01"}},"docking_event":{"test01":{"id":"test01"}},"event":{"test01":{"id":"test01"}},"expedition":{"test01":{"id":"test01"}},"first_stage":{"test01":{"id":"test01"}},"launch":{"test01":{"id":"test01"}},"launch_vehicle":{"test01":{"id":"test01"}},"launcher":{"test01":{"id":"test01"}},"location":{"test01":{"id":"test01"}},"pad":{"test01":{"id":"test01"}},"reusable_first_stage":{"test01":{"id":"test01"}},"space_station":{"test01":{"id":"test01"}},"spacecraft":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new LaunchLibrary2SDK(...)\` and any
// \`LaunchLibrary2SDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+LaunchLibrary2SDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/LaunchLibrary2SDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
