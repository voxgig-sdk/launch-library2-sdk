...
class ExpeditionEntity extends LaunchLibrary2EntityBase<Expedition> {
  ...
  constructor(client: LaunchLibrary2SDK, entopts: any) {
    ...
    this.name_ = 'expedition'
    this.Name = 'Expedition'
  }


  make(this: ExpeditionEntity) {
    return new ExpeditionEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: ExpeditionLoadMatch, ctrl?: Control): Promise<ExpeditionEntity> {
  ...
  async list(this: any, reqmatch?: ExpeditionListMatch, ctrl?: Control): Promise<ExpeditionEntity[]> {
