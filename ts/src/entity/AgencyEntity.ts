...
class AgencyEntity extends LaunchLibrary2EntityBase<Agency> {
  ...
  make(this: AgencyEntity) {
    return new AgencyEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: AgencyLoadMatch, ctrl?: Control): Promise<AgencyEntity> {
