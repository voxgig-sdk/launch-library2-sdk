...
class LauncherEntity extends LaunchLibrary2EntityBase<Launcher> {
  ...
  make(this: LauncherEntity) {
    return new LauncherEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: LauncherLoadMatch, ctrl?: Control): Promise<LauncherEntity> {
