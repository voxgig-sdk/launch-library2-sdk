...
// LaunchLibrary2 SDK rbac feature
...
class LaunchLibrary2RbacFeature extends LaunchLibrary2BaseFeature
{
    ...
    private function _required(LaunchLibrary2Context $ctx): ?string
    {
    ...
    private function _reject(LaunchLibrary2Context $ctx, string $required): void
    {
    ...
    private function _track(LaunchLibrary2Context $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
