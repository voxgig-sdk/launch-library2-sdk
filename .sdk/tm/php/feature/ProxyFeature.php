...
// LaunchLibrary2 SDK proxy feature
...
class LaunchLibrary2ProxyFeature extends LaunchLibrary2BaseFeature
{
    ...
    public function init(LaunchLibrary2Context $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (LaunchLibrary2Context $ctx2, string $url2, array $fetchdef) use ($inner): array {
