...
// LaunchLibrary2 SDK cache feature
...
class LaunchLibrary2CacheFeature extends LaunchLibrary2BaseFeature
{
    ...
    private function _through(LaunchLibrary2Context $ctx, string $url, array $fetchdef, callable $inner): array
    {
