...
// LaunchLibrary2 SDK idempotency feature
...
class LaunchLibrary2IdempotencyFeature extends LaunchLibrary2BaseFeature
{
    ...
    private function _mutating(LaunchLibrary2Context $ctx): bool
    {
