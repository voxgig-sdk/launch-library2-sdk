...
// LaunchLibrary2 SDK clienttrack feature
...
class LaunchLibrary2ClienttrackFeature extends LaunchLibrary2BaseFeature
{
    ...
    public function PostConstruct(LaunchLibrary2Context $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'LaunchLibrary2-SDK';
