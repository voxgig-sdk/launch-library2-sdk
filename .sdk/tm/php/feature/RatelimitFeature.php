...
// LaunchLibrary2 SDK ratelimit feature
...
class LaunchLibrary2RatelimitFeature extends LaunchLibrary2BaseFeature
{
    ...
    private function _acquire(LaunchLibrary2Context $ctx): void
    {
    ...
    private function _track(LaunchLibrary2Context $_ctx, float $wait_ms): void
    {
        $client = $this->client;
