...
// LaunchLibrary2 SDK utility: fetcher

class LaunchLibrary2Fetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; LaunchLibrary2SDK/1.0)';
    ...
    public static function call(LaunchLibrary2Context $ctx, string $fullurl, array $fetchdef): array
    {
