...
// LaunchLibrary2 SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class LaunchLibrary2MakeRequest
{
    public static function call(LaunchLibrary2Context $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new LaunchLibrary2Response(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new LaunchLibrary2Response($fetched);
        } else {
