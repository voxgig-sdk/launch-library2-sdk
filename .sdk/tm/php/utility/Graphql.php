...
// LaunchLibrary2 SDK utility: graphql
//
...
class LaunchLibrary2Graphql
{
    ...
    // equivalent.
    public static function body(LaunchLibrary2Context $ctx): mixed
    {
    ...
    public static function errors(LaunchLibrary2Context $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
