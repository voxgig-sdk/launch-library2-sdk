...
// LaunchLibrary2 SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class LaunchLibrary2TransformResponse
{
    public static function call(LaunchLibrary2Context $ctx): mixed
    {
        ...
        $transform = LaunchLibrary2Helpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
