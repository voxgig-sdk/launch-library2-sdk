...
class LaunchLibrary2TestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = LaunchLibrary2TestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = LaunchLibrary2TestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = LaunchLibrary2TestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
