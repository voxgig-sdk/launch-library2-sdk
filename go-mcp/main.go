// Command LaunchLibrary2-mcp is an MCP server exposing the LaunchLibrary2
// SDK as MCP tools.
//
// Two tools are registered:
//
//	LaunchLibrary2_list  — list records of an entity
//	LaunchLibrary2_load  — load a single record of an entity
//
