# LaunchLibrary2 SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions LaunchLibrary2SDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both LaunchLibrary2SDK(...) and LaunchLibrary2SDK.test(...) become
#      LaunchLibrary2SDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "launchlibrary2_sdk"
_SDK_CLASS = "LaunchLibrary2SDK"
...
_ENTITIES = {
    ...
    "Location": "location",
    "Pad": "pad",
    "ReusableFirstStage": "reusable_first_stage",
