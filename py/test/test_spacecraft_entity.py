    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set LAUNCH_LIBRARY2_TEST_SPACECRAFT_ENTID JSON to run live")
        client = setup["client"]
        ...
        spacecraft_ref01_data_dt0_load_result = helpers.to_map(runner.entity_data(spacecraft_ref01_data_dt0_loaded))
...
def _spacecraft_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "LAUNCH_LIBRARY2_TEST_SPACECRAFT_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("LAUNCH_LIBRARY2_TEST_SPACECRAFT_ENTID"))
