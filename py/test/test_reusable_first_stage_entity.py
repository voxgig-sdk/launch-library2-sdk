    ...
    def test_should_run_basic_flow(self):
        ...
        if setup.get("synthetic_only"):
            pytest.skip("live entity test uses synthetic IDs from fixture — "
                        "set LAUNCHLIBRARY__TEST_REUSABLE_FIRST_STAGE_ENTID JSON to run live")
        client = setup["client"]
...
def _reusable_first_stage_basic_setup(extra):
    ...
    _entid_env_raw = os.environ.get(
        "LAUNCHLIBRARY__TEST_REUSABLE_FIRST_STAGE_ENTID")
    ...
    idmap_resolved = helpers.to_map(
        env.get("LAUNCHLIBRARY__TEST_REUSABLE_FIRST_STAGE_ENTID"))
