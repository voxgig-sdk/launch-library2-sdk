...
from launchlibrary2_sdk.core.helpers import get_ctx_prop, to_map
...
class LaunchLibrary2Context:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = LaunchLibrary2Control()
        ...
        if isinstance(sp, LaunchLibrary2Spec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, LaunchLibrary2Result):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, LaunchLibrary2Response):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return LaunchLibrary2Operation({})
    ...
    def make_error(self, code, msg):
        return LaunchLibrary2Error(code, msg, self)
