...
class LaunchVehicleEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return LaunchVehicleEntity(self._client, opts)
    ...
    def data_get(self) -> LaunchVehicle:
    ...
    def match_get(self) -> LaunchVehicle:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[LaunchVehicle]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.LaunchVehicle().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
