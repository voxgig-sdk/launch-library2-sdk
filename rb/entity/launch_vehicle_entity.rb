...
class LaunchVehicleEntity
  ...
  def make
    opts = @_entopts.dup
    LaunchVehicleEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [LaunchVehicleListMatch, Hash, nil] match filter (any subset of
  #   LaunchVehicle fields); defaults to nil, treated as an empty match that lists all.
