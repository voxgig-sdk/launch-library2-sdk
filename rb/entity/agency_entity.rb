...
class AgencyEntity
  ...
  #   as an empty match, so client.Agency.load works with no args).
  ...
  #
  # @param reqmatch [AgencyListMatch, Hash, nil] match filter (any subset of
  #   Agency fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
