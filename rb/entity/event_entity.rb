# LaunchLibrary2 SDK Event entity
...
class EventEntity
  ...
  # @return [Event, Hash] the loaded Event; raises LaunchLibrary2Error on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Event>, Array] the matching Event items; raises LaunchLibrary2Error on failure
