...
class AstronautEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set LAUNCHLIBRARY__TEST_ASTRONAUT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def astronaut_basic_setup(extra)
  ...
  entid_env_raw = ENV["LAUNCHLIBRARY__TEST_ASTRONAUT_ENTID"]
