...
class PadEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set LAUNCHLIBRARY__TEST_PAD_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def pad_basic_setup(extra)
  ...
  entid_env_raw = ENV["LAUNCHLIBRARY__TEST_PAD_ENTID"]
